...
if(VCPKG_TARGET_IS_WINDOWS)
	...
	# cityhash bundles config.guess from 2009 which doesn't recognize aarch64.
	# Replace with system version if available.
	find_program(_config_guess config.guess PATHS /usr/share/misc /usr/share/automake-1.16)
	if(_config_guess)
		file(COPY "${_config_guess}" DESTINATION "${SOURCE_PATH}")
		find_program(_config_sub config.sub PATHS /usr/share/misc /usr/share/automake-1.16)
		if(_config_sub)
			file(COPY "${_config_sub}" DESTINATION "${SOURCE_PATH}")
		endif()
	endif()
