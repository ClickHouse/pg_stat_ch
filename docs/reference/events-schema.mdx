...
| Column | Type | Description |
|---|---|---|
| `instance_uuid` | `String` | Postgres service UUID supplied through `pg_stat_ch.extra_attributes`. Both Arrow exporters include this field; it is empty when unset. |
