...
| Column | Type | Description |
|---|---|---|
| `instance_uuid` | `String` | Postgres service UUID supplied through `pg_stat_ch.extra_attributes`. Native ClickHouse and both Arrow exporters include this field; OTLP emits it as a log attribute. It is empty when unset. |
