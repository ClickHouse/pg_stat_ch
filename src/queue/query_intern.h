...
//
// Returns InvalidDsaPointer if DSA is unavailable
...
// Release query reference left by an aborted enqueue without copying text
// Free interned object when its last reference is released
