...
//  2. Backends:   Attach before reclaiming or writing queue slots
...
// Free string without copying, skip invalid pointers
// Leave allocation intact if DSA is unavailable
